...
func AnyToFloat64(value any) (float64, error) {
	...
	default:
		return 0, fmt.Errorf("value %v of type %T cannot be converted to float64", typedValue, typedValue)
	}
}
...
func AnyToInt64(value any) (int64, error) {
	...
	default:
		return 0, fmt.Errorf("value %v of type %T cannot be converted to int64", typedValue, typedValue)
	}
}
...
func AnyToBoolean(value any) (bool, error) {
	...
	default:
		return false, fmt.Errorf("value %v of type %T cannot be converted to boolean", typedValue, typedValue)
	}
}
...
func AnyToTime(value any) (time.Time, error) {
	...
	default:
		return time.Time{}, fmt.Errorf("value %v of type %T cannot be converted to type", typedValue, typedValue)
