...
type Lazy[T any] interface {
	...
	OrElse(ctx context.Context, v T) (T, error)
...
func (lp *lazyStreamProvider[T]) Emit(ctx context.Context) (*T, error) {
	...
	lp.fetched = true
	return lp.fetcher(ctx)
}

// NewLazy creates a new lazy with value
func NewLazy[T any](fetcher func(_ context.Context) (*T, error)) Lazy[T] {
...
func (o *lazy[T]) OrElse(ctx context.Context, v T) (T, error) {
	d, err := o.fetcher(ctx)
	if err != nil {
		return functional.DefaultValue[T](), err
	}
	if d == nil {
		return v, nil
	}
