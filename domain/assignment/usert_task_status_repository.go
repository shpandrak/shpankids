...
type UserTaskStatusRepo datekvs.DateKvStore[dbUserTaskStatus]

func NewUserTaskStatusRepository(ctx context.Context, kvs kvstore.RawJsonStore, userId string) (UserTaskStatusRepo, error) {
